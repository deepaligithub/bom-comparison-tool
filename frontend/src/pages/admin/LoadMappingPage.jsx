...
import ManageMappingModal from '../admin/ManageMappingModal'; // ✅ Corrected path
        ...
        <div className="max-w-6xl mx-auto p-6">
            <div className="mb-6 bg-blue-50 border border-blue-200 rounded p-4 text-sm text-blue-900">
                <ul className="list-disc list-inside space-y-1"><b>Note -</b>
                    ...
                    <li><strong>You can edit</strong> the mapping filename and fields anytime.</li> {/* ✅ NEW */}
                </ul>
            </div>
                                ...
                                <div className="flex items-center justify-between mt-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <Switch
                                            ...
                                            className={`${file.active ? 'bg-green-500' : 'bg-gray-300'} relative inline-flex h-5 w-10 items-center rounded-full transition-colors`}
                                            disabled={loading}
                                        >
                                            <span className={`${file.active ? 'translate-x-5' : 'translate-x-1'} inline-block h-4 w-4 transform bg-white rounded-full transition-transform`} />
                                        </Switch>
                                    </div>
